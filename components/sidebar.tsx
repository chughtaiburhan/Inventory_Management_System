...
import { Building2, FileText, Home, Package, Settings, Truck, Users, Wallet, MoreHorizontal, Crown, Bot, Package2, ShoppingCart } from "lucide-react"
...
export function AppSidebar() {
  ...
  return (
    <>
      <Sidebar className="border-r w-[300px] bg-sidebar text-sidebar-foreground dark:bg-sidebar dark:text-sidebar-foreground pt-6">
