  ...
  return (
    <div className="flex-1 space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Service Payroll Management</h1>
          <p className="text-gray-600">Manage service employee salaries and payroll processing</p>
        </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Service Employee Payroll - January 2024</CardTitle>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
